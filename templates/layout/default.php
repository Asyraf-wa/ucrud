...
<?php echo $this->Html->link('<i class="fa-solid fa-arrow-right-from-bracket"></i>', ['prefix' => 'Admin', 'controller' => 'Users', 'action' => 'logout'], ['class' => 'badge_custom_link bg-light border-0 kosong', 'escape' => false, 'alt' => 'Sign-out']); ?>
<script>
// full screen toggle
function toggleFull() {
...
$(document).ready(function(){
	...
	<?php echo $this->Html->script('popper.js'); ?>
	<?php echo $this->Html->script('bootstrap.js'); ?>
	<?php //echo $this->Html->script('perfect-scrollbar.js'); ?>
	<?php echo $this->Html->script('menu.js'); ?>
	<?php //echo $this->Html->script('bootstrapModal'); ?>
...
<?= $this->fetch('scriptBottom') ?>
    ...
    <!-- Page JS -->
	<?php echo $this->Html->script('dashboards-analytics.js'); ?>
